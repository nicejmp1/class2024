...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/897760/items/5044130?theme=place&refererCode=menutab&area=ple"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("puradakchicken.json", "w", encoding='utf-8') as json_file:
