...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/576030/items/4964868?theme=place&entry=pll&area=pll"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("kkubeurakko_chicken.json", "w", encoding='utf-8') as json_file:
