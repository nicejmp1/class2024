...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/1105516/items/5738165?theme=place&refererCode=menutab&area=pll"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("chickenPluse.json", "w", encoding='utf-8') as json_file:
