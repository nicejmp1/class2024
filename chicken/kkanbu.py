...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/746565/items/4568523?theme=place&entry=pll&area=pll"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("kkanbu__chicken.json", "w", encoding='utf-8') as json_file:
