...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/1065723/items/5630706?theme=place&entry=pll&area=pll"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("mbym__chicken.json", "w", encoding='utf-8') as json_file:
